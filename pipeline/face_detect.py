...
def main():
    ...
    roleArn = 'arn:aws:iam::981268234088:role/KEKE'
    bucket = 'bucket-name'
    video = 'video-name'

    session = boto3.Session()
    client = session.client('rekognition', region_name='ap-south-1', use_ssl=True)
    rek = boto3.client('rekognition', region_name='ap-south-1', use_ssl=True)
    sqs = boto3.client('sqs', region_name='ap-south-1', use_ssl=True)
    sns = boto3.client('sns', region_name='ap-south-1', use_ssl=True)
